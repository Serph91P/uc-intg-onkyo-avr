  ...
  commands: {
    ...
    LMD: {
      ...
      values: {
        ...
        "80": { name: ["Dolby-PLIIx-Movie", "pliix-movie", "dolby-surround"], description: "sets PLII/PLIIx Movie" },
        "81": { name: ["Dolby-PLIIx-Music", "pliix-music"], description: "sets PLII/PLIIx Music" },
        ...
        "84": { name: ["Dolby-PLIIx-THX-Cinema", "pliix-thx-cinema"], description: "sets PLII/PLIIx THX Cinema" },
        "85": { name: ["neo-6", "neo-x-thx-cinema"], description: "sets Neo:6/Neo:X THX Cinema" },
        "86": { name: ["Dolby-PLIIx-Game", "pliix-game"], description: "sets PLIIx Game" },
        ...
        "89": { name: ["Dolby-PLIIx-THX-Games", "pliix-thx-games"], description: "sets PLIIx THX Games" },
        "90": { name: ["Dolby-PLIIz-Height", "pliiz-height"], description: "sets PLIIz Height" },
        ...
        "94": { name: ["Dolby-PLIIz-Cinema", "pliiz-height-thx-cinema"], description: "sets PLIIz Height + THX Cinema" },
        "95": { name: ["Dolby-PLIIz-Music", "pliiz-height-thx-music"], description: "sets PLIIz Height + THX Music" },
        "96": { name: ["Dolby-PLIIz-Games", "pliiz-height-thx-games"], description: "sets PLIIz Height + THX Games" },
        ...
        "8B": { name: ["Dolby-PLIIx-THX-Music", "pliix-thx-music"], description: "sets PLIIx THX Music" },
        ...
        A2: { name: ["Dolby-PLIIx", "pliix"], description: "sets PLIIx" },
